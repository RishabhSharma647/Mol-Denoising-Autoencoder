...
De-noising Autoencoder implementation in TensorFlow 2.0 for de-noising chemically invalid SMILES molecule strings to valid analogs (For analog generation/Post-processing generative models data) using one hot encoding for SMILES featurization
